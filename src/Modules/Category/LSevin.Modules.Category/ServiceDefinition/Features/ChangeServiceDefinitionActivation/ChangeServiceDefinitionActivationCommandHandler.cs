...
internal sealed class ChangeServiceDefinitionActivationCommandHandler(
    IServiceDefinitionRepository serviceDefinitionRepository
) : CommandHandler<ChangeServiceDefinitionActivationCommand, Guid>
{
    public override async Task<Result<Guid>> Handle(
        ChangeServiceDefinitionActivationCommand command,
    ...
    )
    {
        ...
        serviceDefinition.ChangeActivation(command.IsActive);
