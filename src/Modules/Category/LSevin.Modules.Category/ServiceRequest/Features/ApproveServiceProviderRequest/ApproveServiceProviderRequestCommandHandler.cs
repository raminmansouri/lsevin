...
internal sealed class ApproveServiceProviderRequestCommandHandler(IServiceProviderRequestRepository repository)
    : CommandHandler<ApproveServiceProviderRequestCommand, bool>
{
    public override async Task<Result<bool>> Handle(
        ApproveServiceProviderRequestCommand command,
