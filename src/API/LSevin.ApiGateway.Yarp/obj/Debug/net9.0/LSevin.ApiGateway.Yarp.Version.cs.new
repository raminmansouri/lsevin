...
internal static partial class ThisAssembly {
    ...
    internal const string AssemblyName = "LSevin.ApiGateway.Yarp";
    internal const string AssemblyTitle = "LSevin.ApiGateway.Yarp";
    ...
    internal const string RootNamespace = "LSevin.ApiGateway.Yarp";
}
