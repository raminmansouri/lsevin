...
/// <summary>
/// Extension methods for adding tags to an Activity.
/// </summary>
public static class TagsExtensions
{
    ...
    public static IReadOnlyCollection<KeyValuePair<string, string?>> MergeTags(
        params IEnumerable<KeyValuePair<string, string?>>[] tagCollections
    )
    {
        ArgumentNullException.ThrowIfNull(tagCollections);

        var mergedTags = new Dictionary<string, string?>(StringComparer.Ordinal);
