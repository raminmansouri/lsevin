...
internal static partial class ThisAssembly {
    ...
    internal const string AssemblyName = "BuildingBlocks.Validation";
    internal const string AssemblyTitle = "BuildingBlocks.Validation";
    ...
    internal const string RootNamespace = "BuildingBlocks.Validation";
}
