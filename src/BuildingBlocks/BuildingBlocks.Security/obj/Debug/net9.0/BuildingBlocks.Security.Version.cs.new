...
internal static partial class ThisAssembly {
    ...
    internal const string AssemblyName = "BuildingBlocks.Security";
    internal const string AssemblyTitle = "BuildingBlocks.Security";
    ...
    internal const string RootNamespace = "BuildingBlocks.Security";
}
