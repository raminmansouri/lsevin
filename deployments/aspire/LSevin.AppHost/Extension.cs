...
namespace LSevin.AppHost;

/// <summary>
/// Extension methods for Aspire.
/// </summary>
public static class Extension
{
    ...
    /// <summary>
    /// Represents a hook to set the ASPNETCORE_FORWARDEDHEADERS_ENABLED environment variable to true for all projects in the application.
    /// </summary>
