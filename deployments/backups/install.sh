...
install -o root -g root -m 0750 "${here}/grant-backup-download-access" /usr/local/sbin/grant-backup-download-access
...
/usr/local/sbin/grant-backup-download-access "${LSEVIN_BACKUP_DOWNLOAD_USER:-agent}"
