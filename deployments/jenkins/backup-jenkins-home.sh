...
CONTROLLER_DIR="${JENKINS_CONTROLLER_DIR:-/opt/lsevin/app/deployments/jenkins}"
ENV_FILE="${CONTROLLER_DIR}/controller.env"
CONTAINER_NAME="${JENKINS_CONTAINER_NAME:-lsevin-jenkins}"
BACKUP_ROOT="${JENKINS_BACKUP_DIR:-/var/backups/lsevin/jenkins}"
HOME_DIR="${JENKINS_HOME_DIR:-/var/lib/lsevin/app/jenkins}"
