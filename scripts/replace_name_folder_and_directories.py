...
# py replace_name_folder_and_directories.py F:\workplace\lsevin\src\Modules\Category\LSevin.Modules.Category\ServiceProvider\Features\GetBookingSteps GetServiceProviders  GetBookingSteps
