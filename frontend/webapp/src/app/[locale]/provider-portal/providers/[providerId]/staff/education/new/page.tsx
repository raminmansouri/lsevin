...
export default async function NewStaffEducationFromStaffPage({
  params,
}: {
  ...
  return (
    <ProviderRecordForm
      ...
      title="Add staff education"
      description="Choose a staff member and add education history."
      fields={fields}
      initialValues={{ providerId, staffId: staff[0]?.id || "" }}
      backHref={providerPortalBack(providerId, "/staff/education")}
