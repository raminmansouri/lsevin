import { SettingsManager } from "@/features/provider-portal/components/settings-manager";
import { getProviderWorkspace } from "@/features/provider-portal/server/repository";
import { requireCurrentUserId } from "@/features/provider-portal/server/session";

export default async function ProviderSettingsPage({ params }: { params: Promise<{ locale: string; providerId: string }> }) {
