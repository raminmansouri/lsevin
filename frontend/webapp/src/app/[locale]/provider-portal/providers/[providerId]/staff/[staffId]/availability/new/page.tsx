...
export default async function NewStaffAvailabilityPage({
  params,
}: {
  ...
  return (
    <ProviderRecordForm
      ...
      description="برای این کارشناس یک بازه زمانی قابل رزرو تعریف کنید. اگر تکرار هفتگی روشن باشد، همین ساعت در هر هفته تکرار می‌شود."
      fields={fields}
      initialValues={{
        providerId,
        staffId,
