...
import { getProviderWorkspace, listOperatingHours } from "@/features/provider-portal/server/repository";
import { requireCurrentUserId } from "@/features/provider-portal/server/session";

export default async function ProviderOperatingHoursPage({ params }: { params: Promise<{ locale: string; providerId: string }> }) {
