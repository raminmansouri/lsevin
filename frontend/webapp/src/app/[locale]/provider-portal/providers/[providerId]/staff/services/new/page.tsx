...
import { providerPortalBack, serviceDefinitionOptions, staffOptions } from "@/features/provider-portal/lib/form-page-utils";

export default async function NewStaffServiceFromStaffPage({ params }: { params: Promise<{ locale: string; providerId: string }> }) {
