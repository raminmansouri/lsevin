...
export default async function NewServiceFaqFromServicesPage({
  params,
}: {
  ...
  return (
    <ProviderRecordForm
      ...
      description="Choose a service and add one customer-facing FAQ."
      fields={fields}
      initialValues={{ providerId, providerServiceId: services[0]?.id || "" }}
      backHref={providerPortalBack(providerId, "/services/faqs")}
