...
export default async function NewStaffGalleryFromStaffPage({
  params,
}: {
  ...
  return (
    <ProviderRecordForm
      ...
      title="Add staff gallery item"
      description="Choose staff and add image/video/GIF to that profile."
      fields={fields}
      initialValues={{
        providerId,
        staffId: staff[0]?.id || "",
      ...
      backHref={providerPortalBack(providerId, "/staff/gallery")}
