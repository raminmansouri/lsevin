...
export default async function EditProviderStaffPage({
  params,
}: {
  ...
  const staff = (await listProviderStaff(userId, providerId, locale)).find(
  ...
  const fields = [
    ...
    },
    {
      ...
      label: "Profile image URL / media id",
      type: "text" as const,
      fullWidth: true,
    },
    ...
    {
      name: "notesEn",
      label: "Provider notes English",
      type: "textarea" as const,
      rows: 3,
    },
    {
      name: "notesFa",
      label: "Provider notes Persian",
      type: "textarea" as const,
      rows: 3,
    },
  ...
  return (
    <ProviderRecordForm
      ...
      initialValues={{
        ...
        nameEn: tr(staff.name, "en-US"),
        nameFa: tr(staff.name, "fa-IR"),
        titleEn: tr(staff.title, "en-US"),
        titleFa: tr(staff.title, "fa-IR"),
        biographyEn: tr(staff.biography, "en-US"),
        biographyFa: tr(staff.biography, "fa-IR"),
        profileImageUrl: staff.profileImageUrl || "",
        specialty: staff.specialty || "",
        experienceYears: staff.experienceYears || "",
        consultationFee: staff.consultationFee,
        notesEn: tr(staff.notes, "en-US"),
        notesFa: tr(staff.notes, "fa-IR"),
