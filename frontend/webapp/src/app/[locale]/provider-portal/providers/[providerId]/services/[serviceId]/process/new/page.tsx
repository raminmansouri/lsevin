...
export default async function NewServiceProcessPage({
  params,
}: {
  ...
  const nextStep =
    related.process.filter((item) => item.providerServiceId === serviceId)
      .length + 1;
  ...
  return (
    <ProviderRecordForm
      ...
      description="Add a step to the customer-facing service process."
      fields={fields}
      initialValues={{
        providerId,
