...
export default async function WalletTransactionsPage() {
  ...
  return (
    <Card>
      <CardHeader className="flex-between border-b"><CardTitle><PageHeader title="Wallet transactions" description="Booking-linked and manual wallet ledger entries" /></CardTitle></CardHeader>
