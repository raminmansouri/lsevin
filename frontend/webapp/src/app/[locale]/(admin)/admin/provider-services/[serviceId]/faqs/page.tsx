...
import { ServiceFaqManager } from "@/features/service-relations/components/service-faq-manager";
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: t("pages.serviceFaqs.title", { default: "Service FAQs" }),
  };
}
  ...
  return (
    <Card>
      <CardHeader className="border-b">
        <CardTitle>
          <PageHeader title={`${details.providerServiceName} · Service FAQs`} />
        </CardTitle>
      </CardHeader>
      <CardContent className="pt-6">
        <ServiceFaqManager providerServiceId={details.providerServiceId} items={details.faqs} />
      </CardContent>
    </Card>
  );
}
