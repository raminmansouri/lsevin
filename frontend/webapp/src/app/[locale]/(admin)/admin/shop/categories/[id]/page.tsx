      ...
      <div className="grid gap-6 lg:grid-cols-[1.3fr,1fr]">
        <div className="space-y-4">
          ...
          <form action={deleteCategoryForm}>
            ...
            <button className="rounded-lg border border-red-300 px-4 py-2 text-sm font-semibold text-red-700">Delete category</button>
          </form>
        </div>

        <section className="rounded-2xl border border-gray-100 bg-white p-5 shadow-sm">
          <h2 className="mb-2 text-sm font-bold text-gray-900">Linked LSevin services (SHP-V01-033)</h2>
          <ul className="mb-3 space-y-1">
            ...
            {!category.serviceLinks.length ? <li className="text-xs text-gray-400">No service links.</li> : null}
          </ul>
