...
export default function EducationBilling() {
  ...
  const invoices = [
    { id: 'INV-2026-003', date: '2026-03-01', amount: 499, status: 'paid' },
    { id: 'INV-2026-002', date: '2026-02-01', amount: 499, status: 'paid' },
    { id: 'INV-2026-001', date: '2026-01-01', amount: 499, status: 'paid' },
  ];
      ...
      <div className="grid grid-cols-2 gap-6 mb-6">
        <div className="bg-gradient-to-br from-amber-600 to-orange-600 rounded-xl p-6 text-white">
          <div className="mb-4">
            ...
            <div className="text-3xl font-bold">Premium Institution</div>
          </div>
