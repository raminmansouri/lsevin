...
export default function TourismSupport() {
  ...
  const navigation = [
    { label: t("navigation.dashboard"), icon: <LayoutDashboard size={20} />, path: '/provider/tourism/dashboard' },
    { label: t("navigation.bookings"), icon: <Calendar size={20} />, path: '/provider/tourism/bookings', badge: 15 },
    { label: t("navigation.tourPackages"), icon: <Package size={20} />, path: '/provider/tourism/packages' },
    { label: t("navigation.destinations"), icon: <MapPin size={20} />, path: '/provider/tourism/destinations' },
    { label: t("navigation.transferServices"), icon: <Plane size={20} />, path: '/provider/tourism/transfers' },
    { label: t("navigation.schedule"), icon: <Calendar size={20} />, path: '/provider/tourism/schedule' },
    { label: t("navigation.pricing"), icon: <DollarSign size={20} />, path: '/provider/tourism/pricing' },
    { label: t("navigation.media"), icon: <Image size={20} />, path: '/provider/tourism/media' },
    { label: t("navigation.analytics"), icon: <BarChart3 size={20} />, path: '/provider/tourism/analytics' },
    { label: t("navigation.billing"), icon: <CreditCard size={20} />, path: '/provider/tourism/billing' },
    { label: t("navigation.support"), icon: <MessageSquare size={20} />, path: '/provider/tourism/support' },
    { label: t("navigation.settings"), icon: <Settings size={20} />, path: '/provider/tourism/settings' },
  ];

  const tickets = [
    { id: 'TKT-5621', subject: t("tickets.packageSyncIssue"), category: t("categories.technical"), priority: 'high', status: 'open', lastReply: t("relativeTime.oneHourAgo") },
    { id: 'TKT-5620', subject: t("tickets.transferBookingError"), category: t("categories.bookings"), priority: 'medium', status: 'in-progress', lastReply: t("relativeTime.threeHoursAgo") },
    { id: 'TKT-5619', subject: t("tickets.paymentSettlementQuestion"), category: t("categories.billing"), priority: 'low', status: 'resolved', lastReply: t("relativeTime.oneDayAgo") },
  ];
      ...
      <div className="bg-gradient-to-br from-cyan-50 to-blue-50 rounded-xl border-2 border-cyan-200 p-6">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-gray-700 mb-4">{t("tourismHelpCenterDescription")}</p>
