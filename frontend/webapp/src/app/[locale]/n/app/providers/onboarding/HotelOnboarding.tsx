      ...
      <div className="max-w-5xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="font-bold text-gray-900">{t("hotelAccommodation")}</div>
            </div>
          </div>
        </div>
        ...
        <div className="mb-10">
          <div className="flex items-center justify-between mb-3">
            ...
            <span className="text-sm text-gray-500">{t("propertyInformation")}</span>
          </div>
        ...
        <div className="bg-white rounded-3xl shadow-2xl border border-gray-200 overflow-hidden">
          <div className="bg-gradient-to-r from-indigo-50 to-blue-50 p-8 border-b border-gray-200">
            <h1 className="text-3xl font-bold text-gray-900 mb-3">{t("hospitalityPropertyRegistration")}</h1>
            <p className="text-gray-600 leading-relaxed">
              {t("listYourHotelOrAccommodationToAttractTravelers")}
            </p>
          </div>
          ...
          <div className="p-8 space-y-8">
            <div>
              <div className="flex items-center gap-3 mb-5">
                ...
                <h2 className="text-xl font-bold text-gray-900">{t("propertyDetails")}</h2>
              </div>
              <div className="grid grid-cols-2 gap-5">
                <div className="col-span-2">
                  <label className="block text-sm font-semibold text-gray-700 mb-2">{t("propertyName")} <span className="text-red-500">*</span></label>
                  <input type="text" placeholder={t("eGGrandPalaceHotel")} className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#083f30]" />
                </div>
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-2">{t("propertyType")} <span className="text-red-500">*</span></label>
                  <select className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#083f30] appearance-none bg-white">
                    ...
                    <option value="boutique">{t("boutiqueHotel")}</option>
                    <option value="apartment">{t("servicedApartment")}</option>
                    <option value="hostel">{t("hostel")}</option>
                  </select>
                </div>
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-2">{t("starRating")}</label>
                  <select className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#083f30] appearance-none bg-white">
                    <option value="">{t("selectRating")}</option>
                    <option value="3">{t("n3Star")}</option>
                    <option value="4">{t("n4Star")}</option>
                    <option value="5">{t("n5Star")}</option>
            ...
            <div>
              <div className="flex items-center gap-3 mb-5">
                ...
                <h2 className="text-xl font-bold text-gray-900">{t("roomCategoriesAmenities")}</h2>
              </div>
              <div className="space-y-5">
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-3">{t("roomTypesOffered")}</label>
                ...
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-3">{t("propertyAmenities")}</label>
                  <div className="grid grid-cols-3 gap-3">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-5">
                ...
                <div>
                  ...
                  <input type="text" placeholder={t("eGBali")} className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#083f30]" />
                </div>
                <div className="col-span-2">
                  <label className="block text-sm font-semibold text-gray-700 mb-2">{t("address")} <span className="text-red-500">*</span></label>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-5">
                ...
                <div>
                  ...
                  <input type="email" placeholder={t("reservationsHotelCom")} className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#083f30]" />
                </div>
              </div>
            </div>
            ...
            <div>
              <div className="flex items-center gap-3 mb-5">
                ...
                <h2 className="text-xl font-bold text-gray-900">{t("propertyGalleryDocuments")}</h2>
              </div>
              <div className="space-y-5">
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-2">{t("propertyPhotos")} <span className="text-red-500">*</span></label>
                  <div className="border-2 border-dashed border-gray-300 rounded-xl p-8 text-center hover:border-[#083f30] transition cursor-pointer">
                    ...
                    <p className="text-sm font-semibold text-gray-700 mb-1">{t("uploadPropertyImages")}</p>
                    <p className="text-xs text-gray-500">{t("jpgOrPngUpTo20Photos")}</p>
                  </div>
                </div>
                <div>
                  ...
                  <div className="border-2 border-dashed border-gray-300 rounded-xl p-6 text-center hover:border-[#083f30] transition cursor-pointer">
                    ...
                    <p className="text-sm font-semibold text-gray-700">{t("uploadLicensePermits")}</p>
                  </div>
                </div>
              </div>
            </div>
