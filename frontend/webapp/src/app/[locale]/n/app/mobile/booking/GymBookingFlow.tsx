...
export default function GymBookingFlow() {
  ...
  const canProceed = () => {
    if (step === 1) return selectedService && selectedTrainer && selectedDate && selectedTime;
  ...
  const getButtonLabel = () => {
    if (step === 1) return 'Continue to Options';
...
=======
            ...
            <div className="flex-1">
              <h1 className="text-lg font-bold text-gray-900">Book Your Workout</h1>
...
=======
        {step === 1 && (
          <div className="space-y-6">
            {/* Select Service */}
            <div>
              <h2 className="text-xl font-bold text-gray-900 mb-4">Choose Your Workout</h2>
              <div className="space-y-3">
                  ...
                  >
                    <div className="flex gap-4 p-4">
                      <div className="relative flex-shrink-0">
                        ...
                        />
                        {service.popular && (
                          <div className="absolute -top-2 -right-2 px-2 py-1 bg-gradient-to-r from-orange-500 to-red-500 text-white rounded-lg text-xs font-bold shadow-md flex items-center gap-1">
                            <Flame size={12} />
                            HOT
                          </div>
                        )}
...
=======
            {selectedService && (
              <div>
                <h2 className="text-xl font-bold text-gray-900 mb-4">Choose Your Trainer</h2>
                <div className="space-y-3">
...
=======
                            <span>{trainer.clients} trained</span>
>>>>>>> d8568000f5551fc8b98d4ef0d4dbce5c6f700965
                          </div>
...
=======
                              <Award size={12} className="text-[#083f30]" />
                              <span className="text-gray-600">{trainer.certifications.length} certs</span>
>>>>>>> d8568000f5551fc8b98d4ef0d4dbce5c6f700965
                            </div>
                          </div>
                        </div>
            ...
            {canProceed() && (
              <div className="bg-gradient-to-r from-green-50 to-emerald-50 border-2 border-green-200 rounded-2xl p-4 shadow-md">
                <div className="flex items-start gap-3 mb-4">
                  ...
                  <div className="flex-1">
                    <h3 className="font-bold text-green-900 mb-2">All Set! Let's Go!</h3>
                    <div className="space-y-1.5 text-sm text-green-800">
                      <div className="flex items-center gap-2">
                        <Dumbbell size={14} className="flex-shrink-0" />
                        <span>Workout: {selectedServiceData?.name}</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <Trophy size={14} className="flex-shrink-0" />
                        <span>Trainer: {selectedTrainerData?.name}</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <Calendar size={14} className="flex-shrink-0" />
...
=======
        ...
        {step === 2 && (
          <div className="space-y-6">
            <div>
              <h2 className="text-xl font-bold text-gray-900 mb-2">Maximize Your Results</h2>
              <p className="text-sm text-gray-600 mb-4">
                Upgrade your fitness journey with these premium options
              </p>
            </div>
...
=======
                              {addon.popular && (
                                <span className="px-2 py-0.5 bg-orange-100 text-orange-700 rounded-md text-xs font-bold flex items-center gap-1">
                                  <TrendingUp size={12} />
                                  BEST VALUE
                                </span>
                              )}
                            ...
                            <p className="text-sm text-gray-600 mb-1">{addon.description}</p>
                            {addon.savings && (
                              <div className="inline-flex items-center gap-1 px-2 py-0.5 bg-green-100 text-green-700 rounded-md text-xs font-bold">
                                <Zap size={12} />
                                {addon.savings}
                              </div>
                            )}
...
=======
                <Flame size={20} className="text-orange-600 flex-shrink-0 mt-0.5" />
                <div>
                  <h3 className="font-bold text-orange-900 mb-1">Transform Your Body</h3>
                  <p className="text-sm text-orange-800">
                    Members who combine training + nutrition see 3x better results
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-lg">
              <div className="p-4 bg-gradient-to-r from-[#083f30] to-[#0a5a44]">
                ...
                <p className="text-sm text-[#eacb7f] mt-1">Review your fitness session</p>
>>>>>>> d8568000f5551fc8b98d4ef0d4dbce5c6f700965
              </div>
...
=======
                    ...
                    <h3 className="font-bold text-gray-900">Selected Workout</h3>
                  </div>
...
=======
                        ...
                        <div className={`px-2 py-0.5 rounded-md text-xs font-bold ${
                          selectedServiceData?.intensity === 'High' 
                            ? 'bg-red-100 text-red-700' 
                            : 'bg-orange-100 text-orange-700'
                        }`}>
>>>>>>> d8568000f5551fc8b98d4ef0d4dbce5c6f700965
...
=======
                    ...
                    <h3 className="font-bold text-gray-900">Session Time</h3>
>>>>>>> d8568000f5551fc8b98d4ef0d4dbce5c6f700965
                  </div>
...
=======
                      <CheckCircle2 size={16} className="text-green-600" />
                      <span className="font-semibold">Spot confirmed - ready to train!</span>
>>>>>>> d8568000f5551fc8b98d4ef0d4dbce5c6f700965
                    </div>
                  </div>
                </div>
                ...
                {selectedAddons.length > 0 && (
                  <div className="pt-4 border-t border-gray-100">
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <h3 className="font-bold text-gray-900">Premium Options</h3>
>>>>>>> d8568000f5551fc8b98d4ef0d4dbce5c6f700965
                    </div>
...
=======
                                {addon.savings && (
                                  <div className="text-xs text-green-600 font-semibold">{addon.savings}</div>
                                )}
                              </div>
                            </div>
                            <span className="font-bold text-gray-900">${addon.price}</span>
...
=======
                    ...
                    {selectedAddons.length > 0 && (
                      <div className="flex items-center justify-between text-sm">
                        <span className="text-gray-600">Premium options</span>
                        <span className="font-semibold text-gray-900">
                          ${selectedAddons.reduce((sum, id) => {
                            const addon = addons.find(a => a.id === id);
                            return sum + (addon?.price || 0);
...
=======
                  <Heart size={20} className="text-blue-600 flex-shrink-0 mt-0.5" />
                  <div>
                    <h3 className="font-bold text-blue-900 mb-1">Flexible Booking</h3>
                    <p className="text-sm text-blue-800 leading-relaxed">
                      Cancel or reschedule up to 2 hours before your session with no penalty.
                    </p>
>>>>>>> d8568000f5551fc8b98d4ef0d4dbce5c6f700965
                  </div>
                </div>
