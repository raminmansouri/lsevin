...
export default function BeautyBookingFlow() {
  ...
  const canProceed = () => {
    if (step === 1) return selectedService && selectedStaff && selectedDate && selectedTime;
...
=======
            ...
            <div className="flex-1">
              <h1 className="text-lg font-bold text-gray-900">Book Your Service</h1>
...
=======
                            <span>{person.clients} clients</span>
>>>>>>> d8568000f5551fc8b98d4ef0d4dbce5c6f700965
                          </div>
...
=======
                            <span className="text-xs text-[#083f30] font-semibold">
                              Available {person.nextAvailable}
>>>>>>> d8568000f5551fc8b98d4ef0d4dbce5c6f700965
                            </span>
                          </div>
                        </div>
            ...
            {canProceed() && (
              <div className="bg-gradient-to-r from-green-50 to-emerald-50 border-2 border-green-200 rounded-2xl p-4 shadow-md">
                <div className="flex items-start gap-3 mb-4">
                  ...
                  <div className="flex-1">
                    <h3 className="font-bold text-green-900 mb-2">Perfect! Your booking is ready</h3>
                    <div className="space-y-1.5 text-sm text-green-800">
                      <div className="flex items-center gap-2">
                        <Sparkles size={14} className="flex-shrink-0" />
                      ...
                      <div className="flex items-center gap-2">
                        <Users size={14} className="flex-shrink-0" />
                        <span>Specialist: {selectedStaffData?.name}</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <Calendar size={14} className="flex-shrink-0" />
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-sm text-gray-600 mb-4">
                Add premium upgrades to make your visit even more special
              </p>
            </div>
...
=======
                ...
                <div>
                  ...
                  <p className="text-sm text-blue-800">
                    Add 2 or more premium services for the ultimate luxury experience
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-lg">
              <div className="p-4 bg-gradient-to-r from-[#083f30] to-[#0a5a44]">
                ...
                <p className="text-sm text-[#eacb7f] mt-1">Review your beauty appointment</p>
>>>>>>> d8568000f5551fc8b98d4ef0d4dbce5c6f700965
              </div>
...
=======
                    ...
                    <h3 className="font-bold text-gray-900">Selected Service</h3>
                  </div>
...
=======
                    ...
                    <h3 className="font-bold text-gray-900">Appointment Time</h3>
>>>>>>> d8568000f5551fc8b98d4ef0d4dbce5c6f700965
                  </div>
                ...
                {selectedAddons.length > 0 && (
                  <div className="pt-4 border-t border-gray-100">
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <h3 className="font-bold text-gray-900">Premium Add-ons</h3>
>>>>>>> d8568000f5551fc8b98d4ef0d4dbce5c6f700965
                    </div>
...
=======
                  ...
                  <div>
                    ...
                    <p className="text-sm text-blue-800 leading-relaxed">
                      Free cancellation up to 24 hours before your appointment. Reschedule anytime.
                    </p>
>>>>>>> d8568000f5551fc8b98d4ef0d4dbce5c6f700965
                  </div>
                </div>
