...
import { getSpecialistByProviderAndService } from "@/features/booking/api/server/get-specialist-by-provider-and-service";
...
export async function GET(request: NextRequest) {
  ...
  const { data, error } = await getSpecialistByProviderAndService(
