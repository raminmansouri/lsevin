...
import { getCpCategoryGroups } from "@/features/service-providers/api/server/get-cp-category-groups";

export async function GET(request: NextRequest) {
  console.log('getCpCategoryGroups called:')
...
const responseTime= searchParams.get("responseTime");
  ...
  const { data, error } = await getCpCategoryGroups(
