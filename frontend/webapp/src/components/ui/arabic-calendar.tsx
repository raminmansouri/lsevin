...
// Configure moment-hijri to use Arabic locale
  ...
  return (
    <DayPicker
      ...
      className={cn(
        ...
        // RTL styles for Arabic calendar
        "rtl:text-right",
      ...
      formatters={{
        ...
        formatWeekdayName: (date) => {
          // Format weekday name in Arabic
          return date.toLocaleDateString("ar-SA", { weekday: "short" });
        },
        formatDay: (date) => {
          // Convert to Hijri day
          const hijriDate = momentHijri(date);
          return hijriDate.format("iD");
        },
        ...formatters,
      }}
      classNames={{
      ...
      components={{
        ...
        DayButton: ArabicCalendarDayButton,
...
function ArabicCalendarDayButton({
  ...
  // Convert Gregorian date to Hijri for display
  const hijriDate = momentHijri(day.date);
  ...
  return (
    <Button
      ...
      variant="ghost"
      size="icon"
      data-day={day.date.toLocaleDateString("ar-SA")}
      data-hijri-day={hijriDay}
