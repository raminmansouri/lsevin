...
export default function RecommendationsSection({
  ...
  const t = useTranslations("components.recommendationsSection");
  ...
  return (
    <div className="space-y-8">
          ...
          <div className="mb-5 flex items-center justify-between gap-4">
            <div>
              <h2 className="mb-1 text-xl font-bold text-gray-900">
                {currentCountry ? t("similarProvidersInCountry", { country: currentCountry }) : t("similarProviders")}
              </h2>
              <p className="text-sm text-gray-600">{t("localSubtitle")}</p>
            </div>
            <button
          ...
          <div className="mb-5 flex items-center justify-between">
            <div>
              <h2 className="mb-1 flex items-center gap-2 text-xl font-bold text-gray-900">
                <TrendingUp size={24} className="text-[#083f30]" /> {t("topInternationalProviders")}
              </h2>
              <p className="text-sm text-gray-600">{t("internationalSubtitle")}</p>
            </div>
          </div>
      ...
      <div className="rounded-3xl bg-gradient-to-br from-[#083f30] to-[#0a5a44] p-8 text-center text-white">
        <h3 className="mb-2 text-2xl font-bold">{t("consultationTitle")}</h3>
        ...
        <button
          ...
          type="button"
        >
          {t("getFreeConsultation")} <ChevronRight size={20} />
        </button>
      </div>
    </div>
  );
