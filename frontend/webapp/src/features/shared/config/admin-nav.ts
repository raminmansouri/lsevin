...
export const ADMIN_NAV: AdminNavEntry[] = [
...

  {
    ...
    items: [
      ...
      { titleKey: "shopCategories", href: "/admin/shop/categories", icon: FolderTree },
      { titleKey: "shopBrands", href: "/admin/shop/brands", icon: Tags },
      { titleKey: "shopAttributes", href: "/admin/shop/attributes", icon: Shapes },
      { titleKey: "shopInventory", href: "/admin/shop/inventory", icon: Boxes },
      { titleKey: "shopWarehouses", href: "/admin/shop/warehouses", icon: Building2 },
      { titleKey: "shopDelivery", href: "/admin/shop/delivery", icon: PackageOpen },
      { titleKey: "shopCoupons", href: "/admin/shop/coupons", icon: TicketPercent },
      { titleKey: "shopMerchandising", href: "/admin/shop/merchandising", icon: LayoutTemplate },
      { titleKey: "shopReviews", href: "/admin/shop/reviews", icon: MessageSquareQuote },
      { titleKey: "shopReturns", href: "/admin/shop/returns", icon: Undo2 },
      { titleKey: "shopRelationReport", href: "/admin/shop/reports/relations", icon: Share2 },
      { titleKey: "shopStockReport", href: "/admin/shop/reports/stock", icon: ClipboardCheck },
