...
import { RemoveStaffAvailabilitySchema } from "./schema";
...
const handler = async (
  ...
  const { staffId, availabilityId } = input;
...
export const removeStaffAvailabilityAction = createAuthenticatedSafeAction(
  RemoveStaffAvailabilitySchema,
  handler
);
