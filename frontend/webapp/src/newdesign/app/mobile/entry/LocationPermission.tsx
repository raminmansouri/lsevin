    ...
    <div className="min-h-screen bg-white flex flex-col" dir={isRTL ? 'rtl' : 'ltr'}>
      ...
      <div className="flex-1 flex items-center justify-center px-6 pt-20">
        <div className="text-center">
          <div className="w-32 h-32 mx-auto mb-8 bg-gradient-to-br from-[#eacb7f] to-amber-300 rounded-full flex items-center justify-center">
            <MapPin size={64} className="text-[#083f30]" strokeWidth={1.5} />
          </div>
          ...
          <div className="mt-8 space-y-3 text-left max-w-sm mx-auto">
            {(t('permissions.locationBenefits', { returnObjects: true }) as string[]).map((benefit, idx) => (
