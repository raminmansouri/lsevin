...
export default function TreatmentDetail() {
  ...
  const treatment = {
    ...
    reviews: 1247,
    images: [
      'https://images.unsplash.com/photo-1622296089863-eb7fc530daa8?w=1200&h=800&fit=crop',
      'https://images.unsplash.com/photo-1629909615957-be38eea5915d?w=1200&h=800&fit=crop',
      'https://images.unsplash.com/photo-1551190822-a9333d879b1f?w=1200&h=800&fit=crop',
