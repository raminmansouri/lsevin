      ...
      <div className="grid grid-cols-3 gap-6 mb-8">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          ...
          <div className="space-y-4">
            {[
              { name: 'Anna Martinez', services: 8, revenue: '$840', image: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100&h=100&fit=crop' },
              { name: 'Maria Santos', services: 6, revenue: '$720', image: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=100&h=100&fit=crop' },
              { name: 'Sofia Rodriguez', services: 7, revenue: '$680', image: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=100&h=100&fit=crop' },
              { name: 'Elena Popescu', services: 5, revenue: '$560', image: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=100&h=100&fit=crop' },
            ].map((staff, idx) => (
