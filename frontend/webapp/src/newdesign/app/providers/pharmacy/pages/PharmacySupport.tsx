...
export default function PharmacySupport() {
  ...
  const tickets = [
    { id: 'TKT-7821', subject: 'Prescription upload issue', category: 'Technical', priority: 'high', status: 'open', lastReply: '45 min ago' },
    { id: 'TKT-7820', subject: 'Inventory sync error', category: 'System', priority: 'medium', status: 'in-progress', lastReply: '2 hours ago' },
    { id: 'TKT-7819', subject: 'Billing inquiry', category: 'Billing', priority: 'low', status: 'resolved', lastReply: '1 day ago' },
  ];
      ...
      <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl border-2 border-green-200 p-6">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-gray-700 mb-4">Browse our help center for answers to common questions about pharmacy operations.</p>
