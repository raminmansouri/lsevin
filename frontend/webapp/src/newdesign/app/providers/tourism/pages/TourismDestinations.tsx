...
export default function TourismDestinations() {
  ...
  const destinations = [
    { name: 'Ubud', region: 'Central Bali', category: 'Cultural', packages: 8, status: 'active', image: 'https://images.unsplash.com/photo-1537996194471-e657df975ab4?w=400&h=300&fit=crop' },
    { name: 'Seminyak', region: 'South Bali', category: 'Beach & Nightlife', packages: 6, status: 'active', image: 'https://images.unsplash.com/photo-1559827260-dc66d52bef19?w=400&h=300&fit=crop' },
    { name: 'Mount Batur', region: 'East Bali', category: 'Adventure', packages: 4, status: 'active', image: 'https://images.unsplash.com/photo-1552733407-5d5c46c3bb3b?w=400&h=300&fit=crop' },
    { name: 'Nusa Penida', region: 'Islands', category: 'Island Tours', packages: 5, status: 'active', image: 'https://images.unsplash.com/photo-1559827260-dc66d52bef19?w=400&h=300&fit=crop' },
  ];
