...
import { LayoutDashboard, Calendar, Hotel, DollarSign, Image, Star, BarChart3, CreditCard, MessageSquare, Settings, Bed, Sparkles } from 'lucide-react';

export default function HotelSection({ title }: { title: string }) {
  const navigation = [
  ...
  return (
    <ProviderSectionPlaceholder
      ...
      dashboardPath="/provider/hotel/dashboard"
    />
  );
}
