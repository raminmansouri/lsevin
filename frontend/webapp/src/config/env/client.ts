...
const rawEnv = {
  ...
  NEXT_PUBLIC_CRM_ANALYTICS_URL: process.env.NEXT_PUBLIC_CRM_ANALYTICS_URL,
  NEXT_PUBLIC_CRM_ANALYTICS_SITE_KEY: process.env.NEXT_PUBLIC_CRM_ANALYTICS_SITE_KEY,
};
...
export const env = {
  ...
  NEXT_PUBLIC_CRM_ANALYTICS_URL: rawEnv.NEXT_PUBLIC_CRM_ANALYTICS_URL,
  NEXT_PUBLIC_CRM_ANALYTICS_SITE_KEY: rawEnv.NEXT_PUBLIC_CRM_ANALYTICS_SITE_KEY,
};
